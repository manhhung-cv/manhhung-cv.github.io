    ...
    .then(data => {
      ...
      shareButtons.forEach(button => {
        button.addEventListener('click', function () {
          ...
          const currentUrl = 'https://hunq.online/AP2/';
...
$(document).ready(function () {
  ...
  $('#hideImagesButton').on('click', function () {
    ...
    var iconClass = $(this).find('i').hasClass('fas fa-images') ? 'fas fa-heading' : 'fas fa-images';
  ...
  var images = document.querySelectorAll('.Feed .Status img');
    ...
    images.forEach(function (img) {
        img.addEventListener('click', function () {
            ...
            modal.innerHTML = '<span class="close">&times;</span><img class="modal-content" src="' + img.src + '"><div class="caption">Power by Hunq.</div>';
